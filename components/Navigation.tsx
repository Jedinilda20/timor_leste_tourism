...
import { FiMenu, FiX, FiMap, FiCompass, FiMapPin, FiImage, FiHeart } from 'react-icons/fi';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          >
            ...
            <div>
              <h1 className={`text-xl font-bold ${isScrolled ? 'text-[#DC241F]' : 'text-white'}`}>
                Timor-Leste
              </h1>
            ...
            {navItems.map((item) => (
              <a
                ...
                className={`flex items-center space-x-1 font-medium transition-colors ${
                  isScrolled
                    ? 'text-gray-700 hover:text-[#DC241F]'
